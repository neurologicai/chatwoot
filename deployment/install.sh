...
***************************************************************************
Woot! Woot!! Leadster server installation is complete.
...
***************************************************************************
              Leadster Installation (v$CW_VERSION)
***************************************************************************
...
EOF
  ...
  echo "➥ 6/9 Installing Leadster. This takes a long while."
...
function help() {
  ...
  cat <<EOF
Usage: cwctl [OPTION]...
Install and manage your Leadster installation.
